Shader "Sprites/Outline"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
				// This function is used by the outline detection.
				// The problematic uv_changed calculation has been removed to prevent visual artifacts like shifting.
				// The function now samples the texture directly with the given UVs.
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				// Use original UVs to sample the main texture, preserving sprite size
